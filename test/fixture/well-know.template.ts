...
export class WellKnown {
  ...
  static EscalationLevelTargetSMS2 = new EscalationSMSTarget('targetSMS2', false, {
    phoneNumber: 'targetSMSNumber2',
  });

  static EscalationLevel2 = new EscalationLevel([WellKnown.EscalationLevelTargetSMS2]);

  static EscalationLevelTargetSMS1 = new EscalationSMSTarget('targetSMS1', false, {
    phoneNumber: 'targetSMSNumber1',
  });

  static EscalationEmailTargetEmail1 = new EscalationEmailTarget('targetEmail1', false, {
    email: 'targetEmailEmail1',
  });

  static EscalationLevel1 = new EscalationLevel(
